/*
T.C. - O(N^2) N*N = Size of grid; Inside nested loops, union() operation can be considered as constant 
S.C. - O(N^2) for parent and size arrays
...
class Solution {
    public int largestIsland(int[][] grid) {
        ...
        // Check if grid cells are all 1s
